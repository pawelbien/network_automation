# examples/cisco_xr/read_info.py

"""
Example: read device information from a Cisco IOS-XR device.

Runs 'show version' and 'show inventory' and prints a structured summary
of the single unit.
"""
