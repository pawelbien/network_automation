# network_automation/platforms/cisco_xr/reboot.py
...
def reboot(client):
    """
    Reload the device. Unlike Cisco IOS, IOS-XR commits config changes
    immediately, so reload has no separate "unsaved changes" prompt.
    """
